package ru.emakhankov.thehungrydeveloper;
...
/*        String[] dishes = {
        ...
        //ArrayAdapter<String> dishesAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, dishes);
        //ArrayAdapter<String> dishesAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1, dishes);
